...
<div class="container ">
    ...
    <div class="container-fluid d-flex justify-content-center mx-auto">
        ...
        <div class="ms-1 mt-2 bg-light rounded">
            ...
            <p style="font-size: .75em">SERIAL 2023</p>
            <h5 class="text-truncate" style="width: 95%; margin-top: -15px">A Lorem ipsum dolor et al. This is a recipe for cooking asdasd w a dwwa da dawd awdawdasd adaw dawd...</h5>
            <div class="d-flex">
                <p class="" style="width: 95%; margin-top: -5px"> Author(s): Juan dela cruz</p>
                <p class="ms-4 " style="width: 95%; margin-top: -5px">Type: Thesis/Dissertation</p>
                <p class="ms-4" style="width: 95%; margin-top: -5px">Published: 09-09-23 </p>
            </div>
            </a>
        </div>
        {{-- end data query --}}
