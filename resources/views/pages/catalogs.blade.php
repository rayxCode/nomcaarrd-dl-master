        ...
        <div class="row mt-4 justify-content-center">
            ...
            <div class="text-center" style="width: 15rem">
                ...
                <form action="{{ url('/bookmark/' . $catalogs['catalog_id']) }}" method="POST">
                    ...
                    <button class="btn bg-success rounded" style="width: 88%" id="addBookmarkBtn" type="submit">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form class="mt-1" action="" method="POST" id="commentform">
                                        ...
                                        <a href="#"><input class="btn btn-success" type="submit" name="submit"
                            ...
                            <li>
                                ...
                                <div class="commentText">
                                    <p class="">Hello this is a test comment and this comment is particularly very
                                        long and it goes on and on and on.</p> <span class="date sub-text">on March 5th,
                                        2014</span>
